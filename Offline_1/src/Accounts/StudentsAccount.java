...
public class StudentsAccount extends Account{
    public StudentsAccount(String username, AccountType type, double initial_deposit) throws InvalidAmountException {
    ...
    public void withdraw(double amount) throws InvalidAmountException, InsufficientBalanceException {
        if(amount < 0)
            ...
            throw new InvalidAmountException("Withdraw amount must be less than balance");
        else
        {
            setBalance(getBalance() - amount);
            Bank.setInternal_fund(Bank.getInternal_fund() - amount);
    ...
    public LoanRequest request_loan(double amount) throws InvalidAmountException {
        if(amount < 0)
            ...
            throw new InvalidAmountException("You cannot request more than 1000");
        else {
